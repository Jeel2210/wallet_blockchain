...
userRouter.route('/add-block')
    // POST /api/user/send-money
    .post(userCtrl.createBlock)

userRouter.route('/add-signture')
    // POST /api/user/send-money
    .post(userCtrl.createSignature)

userRouter.route('/create-transaction-hash')
    // POST /api/user/send-money
    .post(userCtrl.createTranscationHash)


userRouter.route('/transaction-history')
